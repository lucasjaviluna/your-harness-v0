...
- El primer incremento de la Fase 9 tiene un plan aprobado en `docs/PHASE_9_CLI_TUI_PLAN.md`: CLI con Node, entrada normal y slash unificadas, continuación con gates HIL, perfiles genéricos e identidad visual de la TUI. Todavía no está implementado.
